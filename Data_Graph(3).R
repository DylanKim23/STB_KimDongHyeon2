...
table(X2023_STB_survey$Gender, X2023_STB_survey $Gender)

table(X2023_STB_survey$Grade, X2023_STB_survey $Grade)
...
entry <- table(X2023_STB_survey $Gender, X2023_STB_survey $Gender)
barplot(entry, legend = TRUE)

barplot(table(X2023_STB_survey $Grade))

entry <- table(X2023_STB_survey $Grade, X2023_STB_survey $Grade)
barplot(entry, legend = TRUE)
